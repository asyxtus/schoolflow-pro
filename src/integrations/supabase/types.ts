  ...
  public: {
    Tables: {
      ...
      message_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "message_log_school_id_fkey";
            columns: ["school_id"];
            isOneToOne: false;
            referencedRelation: "schools";
            referencedColumns: ["id"];
      ...
      schools: {
        ...
        Relationships: [
          {
            foreignKeyName: "schools_diocese_id_fkey";
            columns: ["diocese_id"];
            isOneToOne: false;
      ...
      sports_fixtures: {
        ...
        Relationships: [
          {
            foreignKeyName: "sports_fixtures_school_id_fkey";
            columns: ["school_id"];
            isOneToOne: false;
            referencedRelation: "schools";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "sports_fixtures_team_id_fkey";
            columns: ["team_id"];
            isOneToOne: false;
      ...
      sports_team_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "sports_team_members_school_id_fkey";
            columns: ["school_id"];
            isOneToOne: false;
            referencedRelation: "schools";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "sports_team_members_student_id_fkey";
            columns: ["student_id"];
            isOneToOne: false;
            referencedRelation: "students";
            referencedColumns: ["id"];
      ...
      staff_invitations: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_invitations_diocese_id_fkey";
            columns: ["diocese_id"];
            isOneToOne: false;
            referencedRelation: "dioceses";
            referencedColumns: ["id"];
      ...
      student_health_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_health_profiles_school_id_fkey";
            columns: ["school_id"];
            isOneToOne: false;
            referencedRelation: "schools";
            referencedColumns: ["id"];
      ...
      user_roles: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_roles_diocese_id_fkey";
            columns: ["diocese_id"];
            isOneToOne: false;
            referencedRelation: "dioceses";
            referencedColumns: ["id"];
      ...
      visitor_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "visitor_log_school_id_fkey";
            columns: ["school_id"];
            isOneToOne: false;
            referencedRelation: "schools";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      diocese_snapshot: {
        ...
        Returns: {
          ...
          open_discipline_incidents: number;
        }[];
      };
      has_role: {
        Args: {
      ...
      is_diocese_admin: {
        Args: { _diocese_id: string; _user_id: string };
        Returns: boolean;
      };
      is_staff_of_school: {
        Args: { _school_id: string; _user_id: string };
      ...
      trend_attendance: {
        Args: { _months?: number; _school_id: string };
        Returns: { month: string; present_rate: number }[];
      };
      trend_clinic_visits: {
        Args: { _months?: number; _school_id: string };
        Returns: { month: string; visits: number }[];
      };
      trend_collections: {
        Args: { _months?: number; _school_id: string };
        Returns: { month: string; amount_fcfa: number }[];
      };
      trend_discipline: {
        Args: { _months?: number; _school_id: string };
        Returns: { month: string; incidents: number }[];
      };
      trend_enrollments: {
        Args: { _months?: number; _school_id: string };
        Returns: { month: string; new_students: number }[];
      };
    };
    Enums: {
      admission_stage: "new" | "review" | "interview" | "offer" | "enrolled" | "rejected";
      app_role:
        | "super_admin"
        | "diocese_admin"
        | "principal"
      ...
      contract_type: "permanent" | "fixed_term" | "part_time" | "volunteer" | "intern";
      discipline_severity: "minor" | "moderate" | "major";
      discipline_status: "open" | "resolved";
      document_owner_type: "student" | "staff" | "school";
      fixture_status: "scheduled" | "completed" | "cancelled";
      gender: "male" | "female";
